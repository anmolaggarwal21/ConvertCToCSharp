...
//        static string pcCommPort = "COM3";
//        const int EV_RXCHAR = 0x0001;
...
//        };
//        static SerialPort hComm;
//        public static byte CalculateCRC8(byte[] data, int len)
//        {
//            byte crc = 0;
//            for (int i = 0; i < len; i++)
//            {
...
//        public static void Byte2Hex(byte[] byteArray, int byteLength, char[] hexString)
//        {
...
//        public static void ByteArrayToHexString(byte[] byteArray, byte[] destBuf)
//        {
...
//        [DllImport("kernel32.dll")]
//        static extern bool GetCommState(SerialPort hFile, [In, Out] ref DCB lpDCB);
...
//        public static void SerialPort_Read(string data, UInt32 len)
//        {
//            char TempChar = '\0';
...
//            while (true)
//            {
//                ReadFile(hComm, out string SerialBuffer, len, out UInt32 NumOfBytes, UIntPtr.Zero);
...
//        catch (Exception)
//        {
//            Console.WriteLine("invalid handle value!");
//        }
...
//            if (SetCommTimeouts(hComm, ref timeouts) == 0)
//            {
